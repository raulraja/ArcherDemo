...
internal object FailureMapper : (Failure) -> FailureType {
    ...
    override fun invoke(from: Failure): FailureType = when (from) {
        ...
        Failure.QueryNotSupported,
        is Failure.InvalidObject -> FailureType.DataNotFound
        Failure.NoConnection -> FailureType.ConnectionError
        Failure.ServerError -> FailureType.ServerError
        is Failure.Unknown -> FailureType.UnknownError
    }
}